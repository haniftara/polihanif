## Cara menjalankan Project Polihanif

1. Clone Repository `git clone https://github.com/haniftara/polihanif.git` ke dalam direktori lokal
2. Import Database `bk_poliklinik1`
3. Konfigurasi koneksi database pada `config/conn.php`.
4. Siapkan web server
5. Website sudah dapat berjalan
