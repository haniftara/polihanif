  ...
  <div class="card-body">
        ...
        ?>
          <tr>
              ...
              <td>
                  ...
                  <a class="btn btn-danger rounded-pill px-3" href="index.php?page=obat&id=<?php echo $data['id'] ?>&aksi=hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
              </td>
          </tr>
        <?php
            }
    ...
    if (isset($_POST['simpan'])) {
        try {
            ...
            echo "<script>alert('Data berhasil disimpan!'); window.location.href='index.php?page=obat';</script>";
        } catch (PDOException $e) {
    ...
    if (isset($_GET['aksi']) && $_GET['aksi'] == 'hapus') {
        try {
            ...
            $stmt->bindParam(':id', $_GET['id']);
            $stmt->execute();
            echo "<script>alert('Data berhasil dihapus!'); window.location.href='index.php?page=obat';</script>";
        } catch (PDOException $e) {
            echo "<script>alert('Error: " . $e->getMessage() . "');</script>";
        }
    }
