    ...
    <section class="content">
      ...
      <div class="row d-flex flex-column">
        <div class="col-4">
          <!-- Registrarion poli -->
          <div class="card">
            <h5 class="card-header bg-light">Daftar Poli</h5>
            <div class="card-body">
        ...
        <div class="col-8">
          ...
          <div class="card">
            <h5 class="card-header bg-light">History Poli</h5>
            <div class="card-body">
...
function loadJadwal(poliId) {
    ...
    xhr.open('GET', 'http://localhost/bk_adel/pages/pasien/poli/get_jadwal.php?poli_id=' + poliId, true);
